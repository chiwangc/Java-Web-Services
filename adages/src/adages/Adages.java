...
public class Adages {
    ...
    private String[] aphorisms = {
	    				...
	    				"Philosophy is a battle against the bewitchment of " + "our intelligence by means of languages.",
    ...
    // Create an Adage and set the words property, which likewise sets the wordCount property.
    // The adage is randomly selected from the array, aphorisms.
    ...
    // Jersey provides automatic conversion to JSON using the Jackson libraries. In this example,
    // the conversion is done manually with the Jackson libraries just to indicate how straightforward it is.
    private String toJson(Adage adage) {
	String json = "If you see thism there's a problem.";
	try {
