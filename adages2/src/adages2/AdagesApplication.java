...
public class AdagesApplication extends Application {
	...
	// To illustrate the different API possibilities, implement the DELETE operation as an anonymous Restlet class.
	// For the remaining operations, follow Restlet best practices and implement each as a Java class.
	// DELETE handler
